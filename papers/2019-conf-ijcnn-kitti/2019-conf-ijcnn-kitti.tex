...
\usepackage[bookmarks=false]{hyperref} %option to remove bookmarks (to pass ieee validation)
\usepackage{comment}
...
\usepackage[caption=false,font=normalsize,labelfont=sf,textfont=sf]{https://www.overleaf.com/project/5c36049001347979500bc77csubfig}
\else
