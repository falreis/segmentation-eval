...
\title{\color{red}{\textit{\textbf{To be determined} - Side Ouputs Merging Evaluation for Convolutional Neural Networks}}
...
\author{
\IEEEauthorblockN{Felipe A. L. Reis, Raquel Almeida\\ Silvio Jamil F. Guimar\~aes, Zenilton K. G. do Patroc\'inio Jr}
\IEEEauthorblockA{\textit{Audio-Visual Information Processing Laboratory} \\
\textit{Pontifical Catholic University of Minas Gerais}\\
Belo Horizonte, Minas Gerais, Brazil \\
\{falreis, raquel.almeida.685026\}@sga.pucminas.br\\ \{sjamil, zenilton\}@pucminas.br}
\and \\
\IEEEauthorblockN{Simon Malinowski, Ewa Kijak}
\IEEEauthorblockA{\textit{Linkmedia, IRISA} \\
\textit{Universit\'e de Rennes 1}\\
Rennes, France \\
