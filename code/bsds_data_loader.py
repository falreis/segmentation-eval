## usage (to train set)
#python bsds_data_loader.py --set=train
...
def load_data(mode):
    ...
    for image, ground in zip(images, grounds):
        ...
        label.append(one_hot_bsds(reduced_ground, height = height, width = width, classes = n_classes))
...
np.save(("data/BSDS500/" + set_name + "_data"), data)
np.save(("data/BSDS500/" + set_name + "_label"), label)
