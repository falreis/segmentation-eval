...
### HED ###
###########
def model_hed(merge_name, vote_value=0, morf=False):
    ...
    b1= side_branch(classes=hc.n_classes, x=x, factor=1, morf=morf) # 480 480 1
    ...
    b2= side_branch(classes=hc.n_classes, x=x, factor=2, morf=morf) # 480 480 1
    ...
    b3= side_branch(classes=hc.n_classes, x=x, factor=4, morf=morf) # 480 480 1
    ...
    b4= side_branch(classes=hc.n_classes, x=x, factor=8, morf=morf) # 480 480 1
    ...
    b5= side_branch(classes=hc.n_classes, x=x, factor=16, morf=morf) # 480 480 1
